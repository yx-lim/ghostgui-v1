"""
Model-generated 2D skeleton viewer with target attachment.
...
from gui.trajectory_colors import qt_color_for_frame
...
class Stickman2DViewer(QGraphicsView):
    ...
    def get_body_point(self, frame_name):
        ...
        kind, name = binding
        try:
            position, _ = self.skeleton_state.get_body_pose(name, kind)
        except KeyError:
            return 0.0, 0.0
