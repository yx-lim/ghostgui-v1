"""External MuJoCo viewer process used by GhostGUI.

Run as an installed module:
    python3 -m application.mujoco_viewer_process

The GUI launches this module as a subprocess and sends simple stdin commands:
...
from core.resources import SOURCE_ROOT, resource_path


# Kept for callers that imported it from the legacy script module.
PROJECT_ROOT = SOURCE_ROOT
MODEL_PATH = resource_path("models/g1_29dof.xml")


def default_playback_cache_path():
    """Return the legacy viewer API's default playback-cache path."""
    return mujoco_playback_cache_path()
